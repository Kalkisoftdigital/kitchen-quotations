...
This project was generated with Angular CLI version 9.0.2 and angular 9.x.
 ...
 6. Run ng serve for a dev server. Navigate to https://kitchen-frontend.cloudjiffy.net/. The app will automatically reload if you change any of the source files.
